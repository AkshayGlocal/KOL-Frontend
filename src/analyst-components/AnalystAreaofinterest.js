...
import DisplayAnalystAreaofinterest from './DisplayAnalystAreaofinterest';
...
export default function AnalystAreaofinterest() {
								...
								<div className="filtersAndMainContent">
									...
									<div className="main-content">
										<div className="kol-display-content">
                                            ...
                                            <DisplayAnalystAreaofinterest Results={result1} />
                                            <DisplayAnalystAreaofinterest Results={result2} />
										</div>
									</div>
								</div>

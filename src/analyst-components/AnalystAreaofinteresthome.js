...
import DisplayAnalystAreaofInteresthome from './DisplayAnalystAreaofinteresthome';
...
export default function AnalystAreaofinteresthome() {
								...
								<div className="filtersAndMainContent">
									...
									<div className="main-content">
										<div className="kol-display-content">
                                            ...
                                            <DisplayAnalystAreaofInteresthome Results={result1} />
                                            <DisplayAnalystAreaofInteresthome Results={result2} />
